YUI.add('moodle-enrol_ucsfsis-groupchoosers', function(Y) {
  ...
  // };
              ...
              for (var sel in selectnexts) {
                ...
                thisselect.on('change', function(e) {
                  ...
                  if (hasid > 0) {
                    ...
                    var uri = "/enrol/ucsfsis/ajax.php?id="+params.courseid+"&action=get"+selectnexts[elementname]+'options&filterid='+filterid+'&sesskey='+M.cfg.sesskey;
    ...
    M.enrol_ucsfsis.init_groupchoosers = function(params) {
