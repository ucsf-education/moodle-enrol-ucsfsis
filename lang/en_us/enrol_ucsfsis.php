...
$string['cleae_conversion_desc'] = "Use this section to convert courses that are using CLEAE course ID for enrollment to SIS course ID.
Specify a feed file from SIS and this will convert the database enrollments to the SIS enrollments where it can find a matching SIS course from the API call.";
...
$string['convertedfrom'] = 'This enrollment was converted from \'{$a}\'.';
...
// $string['host_url_desc'] = 'Enter the UCSF SIS API server address here. For staging use <pre>https://stage-unified-api.ucsf.edu</pre>';
$string['host_url_desc'] = 'Enter the UCSF SIS API server address here, e.g. <pre>https://unified-api.ucsf.edu</pre>';
...
$string['subject_course_help'] = 'Select the subject and SIS course that will be used for enrollments for this course.';
